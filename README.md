...
Интерфейсы могут содержать базовую реализацию методов и свойств. Пример использования интерфейса - смена оружия в кске, каждое оружие имеет один общий интерфейс и благодаря этому его можно легчайше менять и использовать.

UML-схема - важная тема для проектирования архитектуры программы и игры
